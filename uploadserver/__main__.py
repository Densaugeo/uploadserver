...
if __name__ == '__main__':
    ...
    parser.add_argument('--server_certificate' '--certificate', '-c', action='store', default=None, dest='server_certificate',
        help='Specify HTTPS server certificate to use [default: none]')
    parser.add_argument('--client_certificate', action='store', default=None, dest='client_certificate',
